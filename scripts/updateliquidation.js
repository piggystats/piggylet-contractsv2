...
async function upgrade() {
  ...
  const oldLiquidationFacet = '0x649D1BbBc8fc576524666Af177F06Edeb0f2F7E1';
  ...
  const LiquidationFacet = await ethers.getContractFactory('LiquidationFacet')
  ...
  console.log('new liquidationFacet   deployed:', liquidationFacet.address)
  ...
  const oldSelectors = await diamondLoupeFacet.facetFunctionSelectors(oldLiquidationFacet)
  ...
  const cut = [
    ...
    },
    {
      ...
      functionSelectors: getSelectors(liquidationFacet)
    }
  ]
